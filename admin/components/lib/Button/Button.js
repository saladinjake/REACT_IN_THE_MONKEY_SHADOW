...
import { Tooltip as Tooltip_MUI } from "@material-ui/core";
...
const getVariantStyles = (variant) => {
  ...
  switch (variant) {
    ...
    case "error":
      variantStyles = { bg: "brand.errorLight", textColor: "brand.error" };
      variantStyles._active = { ...variantStyles, opacity: 0.85 };
      variantStyles._hover = { ...variantStyles, opacity: 0.85 };
      break;
...
export const Button = ({
  ...
  // const getSecondaryFocus = () =>
  //   variant === "secondary"
  //     ? {
  //         bg: "transparent",
  //         // border: "2px solid brand.black2",
  //         color: "brand.black2",
  //       }
  //     : {};
...
export const IconButton = ({
  ...
  return toolTip ? (
    <Tooltip_MUI title={toolTip} arrow>
      {renderedContent}
    </Tooltip_MUI>
  ) : (
    renderedContent
...
Button.propTypes = {
  ...
  variant: PropTypes.oneOf(["secondary", "primary", "error", ""]),
  sm: PropTypes.bool,
  mute: PropTypes.bool,
